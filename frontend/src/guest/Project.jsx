...
import BackgroundImage from "./../assets/images/bg-image-Photoroom.png";
...
export default function Project() {
  ...
  const handleContextMenu = (event) => {
    ...
    alert(
      "Right-click is disabled on this image. Please avoid copying or saving."
    );
  };
  ...
  return (
    <>
      ...
      >
        ...
        <section id="feature-section" className="bg-gray-100 mt-4">
          <div className="container w-full xl:w-100 mx-auto py-16 px-4">
            <h2
